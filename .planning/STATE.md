# Project State: Tenor Creative Redesign
...
## Accumulated Context
- **Decision:** Moving from "4 Rs" to "Services/Packages" structure.
- **Decision:** Replacing HubSpot with GoHighLevel (GHL) for all forms/calendar/chat.
