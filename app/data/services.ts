import { Sectionhead, NuxtLink, NuxtImg } from "#components"
export const services = [
  ...
  },
  {
    title: "Security",
    slug: "security",
    description: "We keep security simple and effective by default. When you need more, our cybersecurity expertise delivers robust protection without sacrificing performance.",
    icon: "bx:bxs-lock",
  },
  {
    title: "Performance",
