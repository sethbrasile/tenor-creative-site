  ...
  <div class="flex justify-center max-w-[24rem] m-auto my-8">
    <div class="relative flex w-full p-2 bg-gray-300 rounded-full">
      <span class="absolute inset-0 m-1 pointer-events-none" aria-hidden="true">
        <span
          class="absolute inset-0 w-1/2 bg-gray-800 rounded-full shadow-sm shadow-gray-950/10 transform transition-transform duration-150 ease-in-out"
...
.button {
  @apply relative flex-1 text-sm font-medium h-8 rounded-full focus-visible:outline-none focus-visible:ring focus-visible:ring-gray-300 transition-colors duration-150 ease-in-out;
}
</style>
